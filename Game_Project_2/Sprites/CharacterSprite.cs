...
namespace Game_Project_2.Sprites
{
    ...
    public class CharacterSprite
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (CurrentPosition.X > 780 * 1.6f)
                CurrentPosition.X -= CurrentPosition.X - 780 * 1.6f;

            if (CurrentPosition.Y < 170 * 1.6f)
                CurrentPosition.Y += 170 * 1.6f - CurrentPosition.Y;

            if (CurrentPosition.Y > 424 * 1.6f)
                CurrentPosition.Y -= CurrentPosition.Y - 424 * 1.6f;
